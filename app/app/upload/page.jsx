...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const { data: authListener } = supabase.auth.onAuthStateChange((event, session) => {
      ...
      setUser(currentUser);
      if (currentUser) {
        fetchUserAssets(currentUser.email);
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#0b0f19', color: '#f1f5f9', padding: '30px 20px', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      {/* TAB: MY LISTED ASSETS (SELLER DASHBOARD STATUS TRACKER) */}
      ...
      {/* TAB 3: ADMIN PANEL (APPROVAL CONTROL FOR mahmoodoffice9@gmail.com) */}
        ...
        <div style={{ maxWidth: '950px', margin: '0 auto', backgroundColor: '#161e2e', padding: '32px', borderRadius: '20px', border: '1px solid #ef4444' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
            <div>
              ...
              <p style={{ color: '#94a3b8', fontSize: '13px', margin: '4px 0 0 0' }}>Review submissions. Notifications sent to mahmoodoffice9@gmail.com</p>
            </div>
      ...
      {/* TAB 5: UPLOAD (WITH STEP-BY-STEP DYNAMIC ENGLISH GUIDES) */}
      {activeTab === "upload" && (
          ...
          {!user ? (
            ...
            <div style={{ backgroundColor: "#064e3b", padding: "24px", borderRadius: "12px", color: "#34d399", textAlign: "center", border: '1px solid #059669' }}>
              ...
              <p style={{ color: '#cbd5e1', fontSize: '14px', margin: '0 0 20px 0' }}>
                Your asset was sent to the Admin (<strong>mahmoodoffice9@gmail.com</strong>). Once approved, it will be published to the public marketplace!
              </p>
              <button 
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              {/* DYNAMIC DEDICATED INSTRUCTION BOX IN ENGLISH */}
