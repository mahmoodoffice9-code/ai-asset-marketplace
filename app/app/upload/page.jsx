        ...
        <div style={{ maxWidth: "650px", margin: "0 auto", backgroundColor: "#161e2e", padding: "32px", borderRadius: "20px", border: "1px solid #243045" }}>
          ...
          {!user ? (
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              {/* 💡 DYNAMIC INSTRUCTION BOX (SELECTED CATEGORY KE HISAAB SE UPDATE HOGA) */}
              <div style={{ backgroundColor: "#0f172a", padding: "16px", borderRadius: "12px", border: "1px solid #38bdf8" }}>
                <h4 style={{ margin: "0 0 8px 0", color: "#38bdf8", fontSize: "14px", display: "flex", alignItems: "center", gap: "6px" }}>
                  📌 How to upload {formData.category}:
                </h4>

                {formData.category === "n8n Workflow" && (
                  <ol style={{ margin: 0, paddingLeft: "20px", color: "#cbd5e1", fontSize: "13px", lineHeight: "1.6" }}>
                    <li>Apne <strong>n8n Dashboard</strong> par jao aur workflow open karo.</li>
                    <li>Top-Right menu par click kar ke <strong>"Export JSON"</strong> karo.</li>
                    <li>Is `.json` file ko apne <strong>Google Drive</strong> ya <strong>GitHub Gist</strong> par upload karo.</li>
                    <li>Google Drive file ki sharing option <strong>"Anyone with the link can view"</strong> set karke link copy karo aur neeche paste kar do!</li>
                  </ol>
                )}

                {formData.category === "Make.com Flow" && (
                  <ol style={{ margin: 0, paddingLeft: "20px", color: "#cbd5e1", fontSize: "13px", lineHeight: "1.6" }}>
                    <li>Apne <strong>Make.com Scenario</strong> ko open karo.</li>
                    <li>3-dots menu se <strong>"Export Blueprint"</strong> select karo.</li>
                    <li>Is Blueprint `.json` file ko **Google Drive** par upload karke link ko **Public (Anyone with link)** karo.</li>
                    <li>Wo Drive link neeche box mein paste kar do!</li>
                  </ol>
                )}

                {formData.category === "AI Agent" && (
                  <ol style={{ margin: 0, paddingLeft: "20px", color: "#cbd5e1", fontSize: "13px", lineHeight: "1.6" }}>
                    <li>Apne Python / LangChain script ko ek `.zip` folder mein pack karo.</li>
                    <li>Zip file ko **Google Drive** ya **GitHub Repository** par upload karo.</li>
                    <li>Direct Download Link ya Public GitHub Link neeche paste kar do.</li>
                  </ol>
                )}

                {formData.category === "Micro-SaaS" && (
                  <ol style={{ margin: 0, paddingLeft: "20px", color: "#cbd5e1", fontSize: "13px", lineHeight: "1.6" }}>
                    <li>Apne full codebase ki `.zip` file banao ya **GitHub Private Repo** mein daalo.</li>
                    <li>Client ko access dene ke liye Google Drive / Dropbox link generate karo.</li>
                    <li>Link ki permission <strong>Public</strong> rakhein aur neeche input box mein paste karein.</li>
                  </ol>
                )}
              </div>
              ...
              <div>
                <label style={{ display: "block", marginBottom: "6px", fontSize: "13px", color: "#cbd5e1", fontWeight: "600" }}>Deliverable File / Drive URL</label>
                <input
                  type="url"
                  required
              ...
              <div>
                ...
                <textarea
                  rows="4"
                  required
                  placeholder="Explain what this AI workflow does and how it helps..."
